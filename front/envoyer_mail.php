...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;                                   
        $mail->Username   = 'sofian.zaion@imie-paris.fr';                     
        $mail->Password   = 'Nador92230';                              
        $mail->SMTPSecure = 'tls';         
        $mail->Port       = 587;                                    
        ...
        // Envoyer le courriel
        $mail->send();
        echo 'Bonjour et bienvenue sur Yaso Shop, votre message a été envoyé avec succès. <br>
         Nous allons examiner votre demande le plus rapidement possible. Merci de votre compréhension.<br><br>Yaso Shop';
    } catch (Exception $e) {
